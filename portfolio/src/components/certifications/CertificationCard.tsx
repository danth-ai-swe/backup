    ...
    return (
        ...
        >
            ...
            <div className="flex items-start justify-between mb-4">
                <div
                    className="w-12 h-12 iconic rounded-lg bg-primary flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform duration-300">
                            ...
                            <Tooltip>
                                ...
                                <TooltipContent side="top" align="start" className="w-48 p-3">
                                    <div className="space-y-2">
                                        <div className="text-xs font-medium text-foreground mb-2">Additional Skills:
                                        </div>
