...
import {Award, Calendar, ExternalLink, Star, Trophy} from 'lucide-react';
    ...
    return (
        ...
        >
            <div className="flex items-start gap-4">
                {/* Icon */}
                <div
                    className="w-12 h-12 rounded-lg iconic flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform duration-300">
