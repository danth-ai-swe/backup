        ...
        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between md:mb-4 md:gap-4">
            <div className="flex flex-col sm:flex-row sm:items-center space-y-3 sm:space-y-0 sm:space-x-4">
                ...
                <div className="flex items-start justify-between md:block w-full sm:w-auto">
                    ...
                    <div
                        className="w-12 h-12 md:w-16 md:h-16 rounded-lg md:rounded-xl bg-white backdrop-blur-sm border border-white/20 flex items-center justify-center shadow-lg flex-shrink-0 p-2">
                        <Image
                            src={experience.logo}
